...
export function transformToApiPayload(
    ...
    return {
        student: {
            ...
            age_in_july: parseInt(studentInfo.age_in_july || "0") || 0,
            id_passport_number: parseInt(studentInfo.id_passport_number || "0") || 0,
            gender: parseInt(studentInfo.gender || "0") === 0, // 0 = Male (true), 1 = Female (false)
            nationality: parseInt(studentInfo.nationality || "0") || 0,
            weight_height: studentInfo.weight_height || "",
            sibling_order: parseInt(studentInfo.sibling_order || "0") || 0,
            home_language: studentInfo.home_language || "",
            living_with: parseInt(studentInfo.living_with || "0") || 0,
        },
        mother: {
            full_name: familyInfo.mother.full_name,
            birthday: familyInfo.mother.birthday || "",
            age: parseInt(familyInfo.mother.age || "0") || 0,
        ...
        father: {
            ...
            age: parseInt(familyInfo.father.age || "0") || 0,
        ...
        education: {
            ...
            enrollment_year: parseInt(educationHealth.education.enrollment_year || "0") || 0,
            graduation_year: parseInt(educationHealth.education.graduation_year || "0") || 0,
        },
        health: {
            medical_history: educationHealth.health.medical_history || "",
            mobility: parseInt(educationHealth.health.mobility || "0") || 0,
            hearing: parseInt(educationHealth.health.hearing || "0") || 0,
            vision: parseInt(educationHealth.health.vision || "0") || 0,
